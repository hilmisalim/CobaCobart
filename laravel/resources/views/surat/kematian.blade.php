...
<head>
<meta charset="utf-8">
<title> Surat Kematian -- RESOURCE </title>
<!-- Bootstrap -->
...
@foreach ($ms as $data)
	...
	<br /><br />
	<P style="font-family: arial; text-align: center;">SURAT KETERANGAN MENINGGAL DUNIA</p>
	...
	<br />
	Adalah benar warga dan bertempat tinggal di RT. 0{{ $data->rt }}/0{{ $data->rw }} Kelurahan {{ $data->kelurahan }}, Kecamatan {{ $data->kecamatan }}, Kota {{ $data->kota }}, yang telah meninggal dunia pada:
	<br />
	<br />
	<p>	<span>Hari/Tanggal</span>: ...... <br />
		<span>Jam</span>: ...... <br />
	</p>
