...
<head>
<meta charset="utf-8">
<title> Surat Domisili -- RESOURCE </title>
<!-- Bootstrap -->
...
@foreach ($ms as $data)
	...
	<br />
	Adalah benar warga dan bertempat tinggal di RT. 0{{ $data->rt }}/0{{ $data->rw }} Kelurahan {{ $data->kelurahan }}, Kecamatan {{ $data->kecamatan }}, Kota {{ $data->kota }}. 
	<br />
	<br />
