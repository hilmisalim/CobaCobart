...
<head>
<meta charset="utf-8">
<title> Surat Kelahiran -- RESOURCE </title>
<!-- Bootstrap -->
...
@foreach ($ms as $data)
	...
	<br /><br />
	<P style="font-family: arial; text-align: center;">SURAT KETERANGAN KELAHIRAN</p>
	...
	<br />
	Orang tersebut diatas adalah benar-benar warga kami yang baru saja lahir 
	<br />
	<br />
	<p>	<span>Tempat, Tgl. Lahir</span>: {{ $data->tmp_lahir}}, 
		<?php $lahir= $data->tgl_lahir;
		$tanggal = substr($lahir, 8, 2);
		$buln = substr($lahir, 5, 2);
		$tahun = substr($lahir, 0, 4);
		...
		echo $tanggal," ",$bulan[$buln]," ",$tahun;?>
		<br />
		<span>Nama Ayah Kandung</span>: ..... <br />
		<span>Nama Ibu Kandung</span>: .....  <br />
		<span>Anak Ke</span>: .....<br />
	</p>
	<br />
	<br />
